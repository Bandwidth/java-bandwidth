 ...
 * @author vpotapenko
 */
public class BandwidthAccountTransaction {
    ...
    private BandwidthAccountTransaction() {
    }

    public static BandwidthAccountTransaction from(JSONObject jsonObject) {
        BandwidthAccountTransaction transaction = new BandwidthAccountTransaction();
