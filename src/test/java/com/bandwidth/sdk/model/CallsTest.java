...
public class CallsTest {
    ...
    public void shouldGetCallsList() throws Exception {
        ...
        List<Call> callList = calls.getCalls().size(2).get();
    ...
    public void shouldCreateNewCall() throws Exception {
        ...
        Call bandwidthCall = calls.newCall().from("from").to("to").bridgeId("bridgeId").callbackUrl("url").recordingEnabled(true).create();
