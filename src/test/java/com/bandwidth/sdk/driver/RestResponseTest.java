...
public class RestResponseTest {
    ...
    public void shouldParseUrlString() {
        RestResponse response = new RestResponse("https://api.catapult.inetwork.com/v1/users/userId/account", "some response text", 200);
        assertThat(response.getUrl(), equalTo("https://api.catapult.inetwork.com/v1/users/userId/account"));

        response = new RestResponse("https://api.catapult.inetwork.com/v1/users?arg1=value1", "some response text", 200);
    ...
    public void shouldRecognizeErrorStatus() {
        RestResponse response = new RestResponse("https://api.catapult.inetwork.com/v1/", "some response text", 200);
        assertThat(response.getHttpStatus(), equalTo(200));
        assertThat(response.isError(), equalTo(false));

        response = new RestResponse("https://api.catapult.inetwork.com/v1/", "some response text", 404);
